...
export function rangeNotSatisfiable<Body>(body: Body): RangeNotSatisfiable<Body>
...
export function unprocessableEntity<Body>(body: Body): UnprocessableEntity<Body>
